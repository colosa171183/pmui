...
describe("ArrayList Class", function () {
    ...
    it("method 'asArray' should return the ArrayList", function () {
        var notArray = {};
    ...
    it("method 'insert' should insert any item to the ArrayList at the end",
        function () {
    ...
    it("method 'get' should retrieve the item in the index position",
        function () {
            al.insert(testItem1);
            al.insert(testItem2);
            al.insert(testItem4);
    ...
    it("method 'indexOf' should return the first the index of an item found",
        function () {
            al.insert(testItem1);
            al.insert(testItem2);
            al.insert(testItem4);
    ...
    it("method 'remove' should remove the first item in the ArrayList or " +
    ...
    it("method 'getSize' should return the size of the ArrayList", function () {
    ...
    it("method 'isEmpty' should return true if the ArrayList is empty or " +
    ...
    it("method 'contains' should return true if contain an item or false " +
        "if not", function () {
        al.insert(testItem1);
        al.insert(testItem2);
        al.insert(testItem4);
    ...
    it("method 'find' should returns the first item found with the attribute " +
    ...
    it("method 'sort' should order the ArrayList", function () {
        var aTest1 = [testItem3, testItem4, testItem1, testItem5, testItem2],
            aTest2 = [testItem2, testItem5, testItem1, testItem4, testItem3];
        al.insert(testItem1);
        al.insert(testItem2);
        al.insert(testItem3);
        al.insert(testItem4);
        al.insert(testItem5);
        al.sort();
        //expect(al.asArray()).toEqual(aTest1);
        al.sort('asc');
        //expect(al.asArray()).toEqual(aTest2);
    });

    it("method 'getFirst' should return the first element or undefined if " +
    ...
    it("method 'getLast' should return the last element or undefined id the " +
        "array is empty", function () {
    ...
    it("method 'popLast' returns the last element and remove it from the " +
        "ArrayList", function () {
    ...
    it("method 'getDimensionLimit' should return an array with the min and " +
    ...
    it("method 'clear' should empty the array list", function () {
        al.insert(testItem1);
        al.insert(testItem2);
        al.insert(testItem3);
        al.insert(testItem4);
